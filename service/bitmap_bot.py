...
class BitMapBot:
    ...
    def run(self):
        ...
        (order_id, amount, pay_address) = create_order(self.get_api_key(), filename, receive_address, gas_fee)
        #6 对订单进行支付
